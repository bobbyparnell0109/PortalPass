...
export default function ParentLogin() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-sky-600 to-cyan-500 p-6">
      <Card className="w-full max-w-sm animate-fade-up border-0 p-8 shadow-2xl">
        <div className="mb-6 text-center">
          <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-500 to-cyan-400 text-white shadow-lg">
            <Users className="h-7 w-7" />
          </div>
          <h1 className="text-2xl font-black">Parent Portal</h1>
          <p className="text-sm text-muted-foreground">Sign in to view your child's progress</p>
        </div>
